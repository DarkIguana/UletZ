 ...
 * 
 * */
function insertPoint($itemNameUrl, $itemPageTitle, $itemDescriptionTag, $itemitemKeywordTag, $itemName, $itemDescShort, $itemDesc, $itemCat, $itemStatus) {
    global $db;
 ...
 * 
 * */
function updatePoint($itemId, $itemName, $itemNameUrl, $itemPageTitle, $itemDescriptionTag, $itemKeywordTag, $itemStatus, $itemDescShort, $itemDesc, $itemCat, $newFileName = null) {
...
function updatePointImage($itemId, $newFileName) {
    ...
    $rs = updatePoint($itemId, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, $newFileName);
